...
public class DBServlet extends HttpServlet {
  ...
  private static final String LOG_TAG          = DBServlet.class.getName();
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    //
    Verificator verificator = new Verificator(param_id, param_format);
    
    if (!verificator.isValid()){
      errorMessage = "BAD REQUEST: " + verificator.getSingleErrorString();
   ...
   // send other Error Response, WRITER ERROR
      ...
      getLogger().log(Level.SEVERE, LOG_TAG + "NOT SPECIFIED EXCEPTION: " + e.getMessage() , e.getCause());
      return;
    }
  }
